...
let min1, min2, min3, min4;
let sec1, sec2, sec3, sec4;
...
function StartTimerA2() {
  ...
  setTimeout(function () {
    ...
    console.log("StartTimerA2() >> btnClick2 is 0?: " + btnClick2);
...
function StartTimerB1() {
  time3 = 60000;                    //setInterval(1000) = 1초인데, *3분(180초)하면 180,000
  min3 = 1;                         //1
  sec3 = 60;                        //60
  function TIMER3() {
    PLAYTIME3 = setInterval(function() {
      btnClick3 = 1;                //branchinfo 버튼 클릭 여부(true)
      ...
      if (sec3 > 0) {               
        ...
        console.log("StartTimerB1() >> 타이머3(??:??) " + min3 + ":" + sec3);
      }
      if (sec3 == 0) {
        //sec(60) 기준으로 0에서 -1하면 -59 출력
        //따라서 0이면 sec을 60으로 변경하고, value는 0으로 출력
  ...
  setTimeout(function() {
    ...
    btnClick3 = 0;                    //branchinfo 버튼 클릭 여부(false)

    console.log("StartTimerB1() >> 타이머3 삭제");
    console.log("StartTimerB1() >> btnClick3 is 0?: " + btnClick3);

    //서버의 타이머3이 삭제될 때 db.branchUsage에서 branchName이 B인 isUseWmac1을 false로 변경 => 사용중아님
    db.collection('branchUsage').updateOne({branchName : 'B'}, {$set : {isUseWmac1:false} }, function(에러, 결과){
      if(에러){return console.log(에러)}
      console.log('StartTimerB1() >> db.branchUsage - B지점의 Wmac1이 false로 수정(즉, B지점 1번 세탁기 사용끝)')
    })

  }, 60000);                      //3분(180,000)되면 타이머 삭제
}

function StartTimerB2() {
  time4 = 60000;                   //setInterval(1000) = 1초인데, *3분(180초)하면 180,000
  min4 = 1;
  sec4 = 60;
  function TIMER4() {
    PLAYTIME4 = setInterval(function () {
      btnClick4 = 1;                //branchinfo 버튼 클릭 여부(true)
      ...
      if (sec4 > 0) {               
        ...
        console.log("StartTimerB2() >> 타이머4(??:??) " + min4 + ":" + sec4);
      }
      if (sec4 == 0) {
        //sec(60) 기준으로 0에서 -1하면 -59 출력
        //따라서 0이면 sec을 60으로 변경하고, value는 0으로 출력
  ...
  setTimeout(function () {
    ...
    btnClick4 = 0;                    //branchinfo 버튼 클릭 여부(false)

    console.log("StartTimerB2() >> 타이머4 삭제");
    console.log("StartTimerB2() >> btnClick4 is 0?: " + btnClick4);

    //서버의 타이머4가 삭제될 때 db.branchUsage에서 branchName이 B인 isUseWmac2를 false로 변경 => 사용중아님
    db.collection('branchUsage').updateOne({branchName : 'B'}, {$set : {isUseWmac2:false} }, function(에러, 결과){
      if(에러){return console.log(에러)}
      console.log('StartTimerB2() >> db.branchUsage - B지점의 Wmac2이 false로 수정(즉, B지점 2번 세탁기 사용끝)')
    })
  ...
  if (!req.session.nickname) {    //로그인X
    ...
    db.collection('branchUsage').findOne({branchName: 'A'}, function(에러, 결과){
      ...
      //둘 중 하나의 기기가 사용중이지 않을 때는 그냥 기기 사용 가능하도록.... -> 추가
        ...
        res.redirect('/branchinfoA1');
        console.log('/macstatusA1.post >> 모든 기기가 사용중이지 않아 그냥 기기 사용 가능(1번 기기 false)')
      }
      else if(결과.isUseWmac1 == true && 결과.isUseWmac2 == false) { 
        res.redirect('/branchinfoA1');
        console.log('/macstatusA1.post >> 모든 기기가 사용중이지 않아 그냥 기기 사용 가능(2번 기기 false)')
      }
  ...
  if (!req.session.nickname) {    //로그인X
    ...
    db.collection('branchUsage').findOne({branchName: 'A'}, function(에러, 결과){
      ...
      //둘 중 하나의 기기가 사용중이지 않을 때는 그냥 기기 사용 가능하도록.... -> 추가
        ...
        res.redirect('/branchinfoA2');
        console.log('/macstatusA2.post >> 모든 기기가 사용중이지 않아 그냥 기기 사용 가능(1번 기기 false)')
      }
      else if(결과.isUseWmac1 == true && 결과.isUseWmac2 == false) { 
        res.redirect('/branchinfoA2');
        console.log('/macstatusA2.post >> 모든 기기가 사용중이지 않아 그냥 기기 사용 가능(2번 기기 false)')
      }
      //모든 기기가 사용중일 때는 웨이팅 신청 가능하도록....
      else if(결과.isUseWmac1 == true && 결과.isUseWmac2 == true) { 
        // ------------------- 웨이팅 등록 최초 1회 -------------------
...
//2) B지점
app.get('/macstatusB', function (req, res) {

  if(btnClick3 == 1){ console.log("/macstatusB.get >> btnClick3 is 1 : " + btnClick3 ); }
  else              { console.log("/macstatusB.get >> btnClick3 is not 1 : " + btnClick3); }

  if(btnClick4 == 1){ console.log("/macstatusB.get >> btnClick4 is 1 : " + btnClick4 ); }
  else              { console.log("/macstatusB.get >> btnClick4 is not 1 : " + btnClick4); }

  if (!req.session.nickname) {    //로그인X
    res.render('macstatusB.ejs', { session: "true", //});
    시간3 : time3, 분3 : min3, 초3 : sec3, 클릭여부3 : btnClick3,
    시간4 : time4, 분4 : min4, 초4 : sec4, 클릭여부4 : btnClick4});
  }
  else {                          //로그인O
    res.render('macstatusB.ejs', { session: "false", //});
    시간3 : time3, 분3 : min3, 초3 : sec3, 클릭여부3 : btnClick3,
    시간4 : time4, 분4 : min4, 초4 : sec4, 클릭여부4 : btnClick4});
  }
})

//branchfinfoB1으로 redirect
app.post('/macstatusB1', function(req, res) {
  if (!req.session.nickname) {    //로그인X
    res.redirect('/awaituse');
    console.log("/macstatusB1.post >> 로그인X - 웨이팅 신청 불가")
  }
  else {                          //로그인O

    //모든 기기가 사용중이지 않을 때는 그냥 기기 사용 가능하도록.... -> 추가
    db.collection('branchUsage').findOne({branchName: 'B'}, function(에러, 결과){
      console.log('/macstatusB1.post >> 결과 : ' + 결과) 
      console.log('/macstatusB1.post >> 결과.isUseWmac1 is false : ' + 결과.isUseWmac1)
      console.log('/macstatusB1.post >> 결과.isUseWmac2 is false : ' + 결과.isUseWmac2)

      //모든 기기가 사용중이지 않을 때는 그냥 기기 사용 가능하도록.... -> 추가
      if(결과.isUseWmac1 == false && 결과.isUseWmac2 == false) { 
        res.redirect('/branchinfoB1');
        console.log('/macstatusB1.post >> 모든 기기가 사용중이지 않아 그냥 기기 사용 가능(모든 기기 false)')
      }
      //둘 중 하나의 기기가 사용중이지 않을 때는 그냥 기기 사용 가능하도록.... -> 추가
      else if(결과.isUseWmac1 == false && 결과.isUseWmac2 == true) { 
        res.redirect('/branchinfoB1');
        console.log('/macstatusB1.post >> 모든 기기가 사용중이지 않아 그냥 기기 사용 가능(1번 기기 false)')
      }
      else if(결과.isUseWmac1 == true && 결과.isUseWmac2 == false) { 
        res.redirect('/branchinfoB1');
        console.log('/macstatusB1.post >> 모든 기기가 사용중이지 않아 그냥 기기 사용 가능(2번 기기 false)')
      }
      //모든 기기가 사용중일 때는 웨이팅 신청 가능하도록....
      else if(결과.isUseWmac1 == true && 결과.isUseWmac2 == true) { 
        // ------------------- 웨이팅 등록 최초 1회 -------------------
        //db.waitinfo에서 userid가 로그인한 유저의 id인 데이터를 조회
        db.collection('waitinfo2').findOne({userid : req.user.id}, function(에러, 결과2) {
          if(에러) return done(에러)
    
          if(결과2 == null) { //신청 이력이 없음
            res.redirect('/awaituse')
            console.log('/macstatusB1.post >> 최초 1회 - 현재 웨이팅 신청 가능')
            return
          }
        })
        ...
        // ------------------- 웨이팅 등록 재사용 -------------------
        //db.waitinfo에서 userid가 로그인한 유저의 id인 데이터를 조회
        db.collection('waitinfo2').find({userid : req.user.id}).toArray(function(에러, 결과2) {
          if(에러) return done(에러)
          
          var 유저의웨이팅신청수 = 결과2.length
          console.log("/macstatusB1.post >> 1회 이상 - " + req.user.id + "의 웨이팅신청수(arr.length) : " + 유저의웨이팅신청수);
          ...
          if (찾았니 == "못찾음") {
            res.redirect('awaituse');
            console.log('/macstatusB1.post >> 1회 이상 - 현재 웨이팅 신청 가능')
          }
          else if(찾았니 == "찾음"){
            //신청 시 부여된 myNumber 순서대로 웨이팅 사용하기 위해 <<페이지 이동>>
            //웨이팅 순서대로 하는 코드
            //db.counter에서 name이 대기인원수인 데이터를 조회
            db.collection('counter').findOne({name: '대기인원수2'}, function(에러, 결과1){
              var 현재순서고유번호 = 결과1.totalUse + 1;
    
              //웨이팅 사용하기 위해 페이지 이동하는 코드
              if(현재순서고유번호 == 찾은고유번호) {  //자신의 차례라서 branchinfo로 이동 => 웨이팅 사용 가능
                console.log("/macstatusB1.post >> 현재순서고유번호 : " + 현재순서고유번호 + ", 찾은고유번호 : " + 찾은고유번호)
    
                res.redirect('/branchinfoB1');
                console.log('/macstatusB1.post >> 1회 이상 - 현재 웨이팅 신청 불가(되어있음)')
              }
              else {                                //자신의 차례 아니라서 bwaituse로 이동 => 웨이팅 사용 불가
                res.redirect('/bwaituseB');
              }
...
//branchinfoB2로 redirect
app.post('/macstatusB2', function(req, res) {
  if (!req.session.nickname) {    //로그인X
    res.redirect('/awaituse');
    console.log("/macstatusB2.post >> 로그인X - 웨이팅 신청 불가")
  }
  else {                          //로그인O
    
    //모든 기기가 사용중이지 않을 때는 그냥 기기 사용 가능하도록.... -> 추가
    db.collection('branchUsage').findOne({branchName: 'B'}, function(에러, 결과){
      console.log('/macstatusB2.post >> 결과 : ' + 결과) 
      console.log('/macstatusB2.post >> 결과.isUseWmac1 is false : ' + 결과.isUseWmac1)
      console.log('/macstatusB2.post >> 결과.isUseWmac2 is false : ' + 결과.isUseWmac2)

      //모든 기기가 사용중이지 않을 때는 그냥 기기 사용 가능하도록.... -> 추가
      if(결과.isUseWmac1 == false && 결과.isUseWmac2 == false) { 
        res.redirect('/branchinfoB2');
        console.log('/macstatusB2.post >> 모든 기기가 사용중이지 않아 그냥 기기 사용 가능(모든 기기 false)')
      }
      //둘 중 하나의 기기가 사용중이지 않을 때는 그냥 기기 사용 가능하도록.... -> 추가
      else if(결과.isUseWmac1 == false && 결과.isUseWmac2 == true) { 
        res.redirect('/branchinfoB2');
        console.log('/macstatusB2.post >> 모든 기기가 사용중이지 않아 그냥 기기 사용 가능(1번 기기 false)')
      }
      else if(결과.isUseWmac1 == true && 결과.isUseWmac2 == false) { 
        res.redirect('/branchinfoB2');
        console.log('/macstatusB2.post >> 모든 기기가 사용중이지 않아 그냥 기기 사용 가능(2번 기기 false)')
      }
      //모든 기기가 사용중일 때는 웨이팅 신청 가능하도록....
      else if(결과.isUseWmac1 == true && 결과.isUseWmac2 == true) { 
        // ------------------- 웨이팅 등록 최초 1회 -------------------
        ...
        db.collection('waitinfo2').findOne({userid : req.user.id}, function(에러, 결과2) {
          ...
          if(결과2 == null) { //신청 이력이 없음
            res.redirect('/awaituse')
            console.log('/macstatusB2.post >> 최초 1회 - 현재 웨이팅 신청 가능')
            return
          }
        })
        ...
        db.collection('waitinfo2').find({userid : req.user.id}).toArray(function(에러, 결과2) {
          ...
          var 유저의웨이팅신청수 = 결과2.length
          console.log("/macstatusB2.post >> 1회 이상 - " + req.user.id + "의 웨이팅신청수(arr.length) : " + 유저의웨이팅신청수);
          ...
          if (찾았니 == "못찾음") {
            res.redirect('awaituse');
            console.log('/macstatusB2.post >> 1회 이상 - 현재 웨이팅 신청 가능')
          }
          else if(찾았니 == "찾음"){
            //신청 시 부여된 myNumber 순서대로 웨이팅 사용하기 위해 <<페이지 이동>>
            //웨이팅 순서대로 하는 코드
            ...
            db.collection('counter').findOne({name: '대기인원수2'}, function(에러, 결과1){
              ...
              //웨이팅 사용하기 위해 페이지 이동하는 코드
              if(현재순서고유번호 == 찾은고유번호) {  //자신의 차례라서 branchinfo로 이동 => 웨이팅 사용 가능
                console.log("/macstatusB2.post >> 현재순서고유번호 : " + 현재순서고유번호 + ", 찾은고유번호 : " + 찾은고유번호)

                res.redirect('/branchinfoB2');
                console.log('/macstatusB2.post >> 1회 이상 - 현재 웨이팅 신청 불가(되어있음)')
              }
              else {                                //자신의 차례 아니라서 bwaituse로 이동 => 웨이팅 사용 불가
                res.redirect('/bwaituseB');
              }
...
//7. 웨이팅 등록 페이지 - 모든 기기가 작동중인 경우만 웨이팅 신청 가능
//1) A지점
...
//2) B지점
app.get('/waitB', isLogin, function(req, res) {
  console.log("/waitB.get >> req.user : " + req.user);
...
app.post('/waitB', isLogin, function(req, res){
  //db.branchUsage에서 branchName이 B인 데이터를 조회
  db.collection('branchUsage').findOne({branchName: 'B'}, function(에러, 결과){
    if (에러) return done(에러)
  
    if(결과 != null) { //모든 기기가 사용중인 경우(모두 true)
      if(결과.isUseWmac1 == true && 결과.isUseWmac2 == true) {
        console.log('/waitB.post >> db.branchUsage - B지점의 모든 기기가 사용중')

        //웨이팅 신청가능으로 WaitReq2() 호출
        WaitReq2();
      }
      else {
        res.render('waitfail.ejs')
        console.log('/waitB.post >> db.branchUsage - B지점의 모든 기기가 사용중이지 않음')
        console.log('/waitB.post >> db.branchUsage - B지점의 Wmac1의 상태 >>> ' + 결과.isUseWmac1)
        console.log('/waitB.post >> db.branchUsage - B지점의 Wmac2의 상태 >>> ' + 결과.isUseWmac2)
      }   
    }
    else {
      console.log('/waitB.post >> db.branchUsage - B지점의 조회 결과가 null')
    }
  })
    ...
    db.collection('counter').findOne({name: '대기인원수2'}, function(에러, 결과1){
      ...
      db.collection('waitinfo2').find({userid : req.user.id}).toArray(function(에러, 결과2) {
        ...
        if(결과2.length == 0) { //신청 이력이 없음
          ...
          //db.waitinfo에 웨이팅 신청 정보를 저장(_id : waitinfo개수+1로 새로운 데이터를 저장)
          db.collection('waitinfo2').insertOne( {_id : waitinfo개수 + 1, 
            myNumber : waitinfo개수 + 1, userid : req.user.id, wmac : 0, isUseWait : false} , function(에러, 결과){
            
            console.log("/waitB.post >> 결과 : " + 결과)
            console.log("/waitB.post >> 에러 : " + 에러)

            if (결과 != undefined) {
              console.log('/waitB.post >> 최초 1회 - 대기인원 데이터 저장 성공');

              //db.counter에서 name이 대기인원수인 totalWait을 +1 증가하여 수정(즉, 총대기인원수+1)
              //operator 종류 : $set(변경), $inc(증가), $min(기존값보다 적을 때만 변경), $rename(key값 이름변경)
              db.collection('counter').updateOne({name: '대기인원수2'}, {$inc: {totalWait:1} }, function(에러, 결과){
                if(에러){return console.log(에러)}
                res.redirect('/waitsuccess')
                console.log('/waitB.post >> 최초 1회 - 웨이팅 신청 성공')
              })
            }
            else {
              res.redirect('/waitB')
        ...
        // ------------------- 웨이팅 등록 1회 이상(재사용) ---------------
          ...
          if (찾았니 == "못찾음") {
            //db.waitinfo에 웨이팅 신청 정보를 저장(_id : waitinfo개수+1로 새로운 데이터를 저장)
            db.collection('waitinfo2').insertOne( {_id : waitinfo개수 + 1, myNumber : waitinfo개수 + 1, userid : req.user.id, wmac : 0, isUseWait : false} , function(에러, 결과){
              console.log('/waitB.post >> 1회 이상 - 대기인원 데이터 저장 성공');
              console.log("/waitB.post >> 결과 : " + 결과)
              console.log("/waitB.post >> 에러 : " + 에러)
              ...
              if (결과 != undefined) {
                ...
                db.collection('counter').updateOne({name: '대기인원수2'}, {$inc: {totalWait:1} }, function(에러, 결과){
                  if(에러){return console.log(에러)}
                  res.redirect('/waitsuccess')
                  console.log('/waitB.post >> 1회 이상 - 웨이팅 신청 성공')
                })
              }
              else {
                res.redirect('/waitB')
            ...
            res.redirect('/waitalready')
            console.log('/waitB.post >> 1회 이상 - 웨이팅 신청 실패(이유 : 웨이팅 신청 되어있음)')
          }
        }
...
//2) B지점
app.get('/waitcheckB', isLogin, function(req, res) {
  console.log("/waitcheckB.get >> req.user : " + req.user);
  ...
  db.collection('waitinfo2').findOne({userid : req.user.id}, function(에러, 결과2) {
    ...
    if(결과2 == null) { //신청 이력이 없음
      res.redirect('/awaituse')
      console.log('/waitcheckB.get >> 최초 1회 - 웨이팅 사용 후 확인(미신청 후 확인)');
      return
    }
    else{
      console.log('/waitcheckB.get >> 최초 1회 - 웨이팅 사용 전 확인')
    }
  })
  ...
  db.collection('waitinfo2').find({userid : req.user.id}).toArray(function(에러, 결과2) {
    ...
    var 유저의웨이팅신청수 = 결과2.length
    console.log("/waitcheckB.get >> 1회 이상 - " + req.user.id + "의 웨이팅신청수(arr.length) : " + 유저의웨이팅신청수);
    ...
    db.collection('counter').findOne({name: '대기인원수2'}, function(에러, 결과3) { 
      var totalUse = 결과3.totalUse
      var left = 찾은고유번호 - totalUse - 1

      console.log("찾은기기번호 is 0? : " + 찾은기기번호)
      console.log("left is 0? : " + left)

        //wmac 변경 부분
        if(찾은기기번호 == 0 && left == 0){ //wmac이 0 + 앞에 남은 인원이 0인 경우에 wmac 수정
          //기기의 타이머가 1분 기준이면 30초 이하로 남았을 때 지정된 wmac으로 수정
          if(min3 == 0 && sec3 <= 30) { //Timer3의 시간이 30초 남았을 때 = wamc1이 30초 남았을 때
            //wmac을 1로 update하는 부분
            db.collection('waitinfo2').updateOne({userid : req.user.id}, {$set: {wmac:1} }, function(에러, 결과){
              console.log("/waitcheckB.get >> Timer3이 30초 이하로 남아 wmac을 0에서 1로 수정")
            })
          }
          else if(min4 == 0 && sec4 <= 30) { //Timer4의 시간이 30초 남았을 때 = wamc2이 30초 남았을 때
            //wmac을 2로 update하는 부분
            ...
            //wmac을 1로 update하는 부분
            db.collection('waitinfo2').updateOne({userid : req.user.id}, {$set: {wmac:1} }, function(에러, 결과){
              console.log("/waitcheckB.get >> Timer3과 Timer4가 모두 진행중이지 않아 wmac을 0에서 1로 수정")
            })
          }
          else {
            console.log("/waitcheckB.get >> wmac 변경 오류")
            console.log("찾은기기번호 : " + 찾은기기번호)
            console.log("left : " + left)
            console.log("min3 : " + min3 + ", sec3 : " + sec3)
            console.log("min4 : " + min4 + ", sec4 : " + sec4)
          }
        }
        else if(찾은기기번호 == 0 && left == 1){ //wmac이 0 + 앞에 남은 인원이 1인 경우에 wmac 수정
          console.log('/waitcheckB.get >> 1회 이상 - left is 1? : ' + left)
          console.log('/waitcheckB.get >> 1회 이상 - wmac이 0 + 앞에 남은 인원이 1로 wmac 수정')

          //웨이팅을 사용하지 않은 사람 중..
          db.collection('waitinfo2').find({isUseWait : false}).toArray(function(에러, 결과4) { 
            console.log('/waitcheckB.get >> waitinfo2에서 isUseWait이 false인 경우 : ' + 결과4)

            if(결과4[0].wmac == 1) {      //wmac을 1로 지정받은 사람이 있으면
              //wmac을 2로 수정
              db.collection('waitinfo2').updateOne({userid : req.user.id}, {$set: {wmac:2} }, function(에러, 결과){
                 console.log("/waitcheckB.get >> wmac을 1로 지정받은 사람이 있어 wmac을 0에서 2로 수정")
              })       
            }
            else if(결과4[0].wmac == 2) { //wmac을 2로 지정받은 사람이 있으면
              //wmac을 1로 수정
              db.collection('waitinfo2').updateOne({userid : req.user.id}, {$set: {wmac:1} }, function(에러, 결과){
                 console.log("/waitcheckB.get >> wmac을 1로 지정받은 사람이 있어 wmac을 0에서 1로 수정")
              })
            }
          })
        }
    ...
    if (찾았니 == "못찾음") {
      console.log('/waitcheckB.get >> 1회 이상 - 웨이팅 사용 후 확인')
      return res.redirect('/awaituse')
    }
    else if(찾았니 == "찾음"){     
      console.log('/waitcheckB.get >> 1회 이상 - 웨이팅 사용 전 확인') 
      return res.redirect('/bwaituseB')
    }
...
//2) B지점
app.get('/bwaituseB', isLogin, function(req, res) {
  console.log("/bwaituseB.get >> req.user : " + req.user);
  
  //db.waitinfo에서 userid가 로그인한 유저의 id인 데이터를 조회
  db.collection('waitinfo2').find({userid : req.user.id}).toArray(function(에러, 결과2) {
    if(에러) return done(에러)

    console.log("/bwaituseB.get >> " + req.user.id + "의 웨이팅신청수 : " + 결과2.length);
    ...
    if (찾았니 == "찾음") {
      //db.counter에서 name이 대기인원수2인 데이터 찾기
      db.collection('counter').findOne({name: '대기인원수2'}, function(에러, 결과3){
        var totalWait = 결과3.totalWait
        var totalUse = 결과3.totalUse
        var left = 찾은고유번호 - totalUse - 1

        console.log("/bwaituseB.get >> 총대기인원수 : " + totalWait)
        console.log("/bwaituseB.get >> 총대기사용수 : " + totalUse)
        console.log("/bwaituseB.get >> 앞에남은인원수 : " + left)

        //찾은 데이터를 bwaituse.ejs 안에 넣기(req.user를 사용자라는 이름으로 보내기)
        res.render('bwaituseB.ejs', {사용자 : req.user, 본인웨이팅번호 : 찾은고유번호, 
                                    본인기기번호 : 찾은기기번호, 대기사용수 : totalUse})
      })
    }
    else if(찾았니 == "못찾음"){
...
//신청 시 부여된 myNumber 순서대로 웨이팅 사용 가능 (+추가예정 : 부여된 wmac로 웨이팅 사용 가능)
  ...
  db.collection('waitinfo').find({userid : req.user.id}).toArray(function(에러, 결과2) {
    ...
    if (찾았니 == "못찾음") {
      ...
      db.collection('counter').findOne({name: '대기인원수'}, function(에러, 결과1){
        ...
        if(현재순서고유번호 == 찾은고유번호) {
          console.log("/branchinfoA.post >> '현재순서고유번호 == 찾은고유번호'임 현재순서고유번호 : " + 현재순서고유번호)
...
//2) B지점
// 지점 상세정보 페이지 - A지점 wmac1
app.get('/branchinfoB1', function (req, res) {
  if (!req.session.nickname) {    //로그인X
    res.render('branchinfoB1.ejs', { session: "true" });
  }
  else {                          //로그인O
    res.render('branchinfoB1.ejs', { session: "false" });
  }
})
// 지점 상세정보 페이지 - A지점 wmac2
app.get('/branchinfoB2', function (req, res) {
  if (!req.session.nickname) {    //로그인X
    res.render('branchinfoB2.ejs', { session: "true" });
  }
  else {                          //로그인O
    res.render('branchinfoB2.ejs', { session: "false" });
  }
})

//신청 시 부여된 myNumber 순서대로 웨이팅 사용 가능 (+추가예정 : 부여된 wmac로 웨이팅 사용 가능)
app.post('/branchinfoB', function(req, res) {
  //웨이팅 신청 없이 사용하는 사람들
  db.collection('waitinfo2').find({userid : req.user.id}).toArray(function(에러, 결과2) {
    var 찾은사용여부
    for (let i = 0; i < 결과2.length; i++) {
    ...
    console.log("/branchinfoB.post >> 결과 >>")
    console.log(결과2)

    //웨이팅 신청없이 사용하는 경우
    if(결과2.length == 0 || 찾은사용여부 == true) {
      console.log("/branchinfoB.post >> 웨이팅 신청 없이 사용하는 사람들")
    }
  })
  ...
  db.collection('waitinfo2').findOne({userid : req.user.id}, function(에러, 결과2) {
    ...
    if(결과2 == null) {
      res.redirect('/awaituse')
      console.log('/branchinfoB.post >> 최초 1회 - 웨이팅 사용 후 확인(미신청 후 waitcheck)');
      return
    }
    else{
      console.log('/branchinfoB.post >> null값이 아니면 등록 재사용으로..')
    }
  })
  ...
  db.collection('waitinfo2').find({userid : req.user.id}).toArray(function(에러, 결과2) {
    ...
    console.log("/branchinfoB.post >> 1회 이상 - " + req.user.id + "의 웨이팅신청수 : " + 결과2.length);
    ...
    if (찾았니 == "못찾음") {
      res.redirect('/awaituse')
      console.log('/branchinfoB.post >> 1회 이상 - 웨이팅 사용 후 확인(미신청 후 확인)')
    }
    else if(찾았니 == "찾음"){
      //1. 신청 시 부여된 myNumber 순서대로 웨이팅 사용
      // 1) 만약에 웨이팅번호 = totalUse(사용인원) + 1것과 db에서 찾은 myNumber가 같다면 => 웨이팅 순서대로 하는 코드
      //db.counter에서 name이 대기인원수인 데이터를 조회
      db.collection('counter').findOne({name: '대기인원수2'}, function(에러, 결과1){
        var waitinfo2개수 = 결과1.totalWait + 결과1.totalUse;
        var 현재순서고유번호 = 결과1.totalUse + 1;

        if(현재순서고유번호 == 찾은고유번호) {
          console.log("/branchinfoB.post >> '현재순서고유번호 == 찾은고유번호'임 현재순서고유번호 : " + 현재순서고유번호)
          console.log("/branchinfoB.post >> waitinfo2개수 : " + waitinfo2개수)
          console.log("/branchinfoB.post >> 현재순서고유번호 : " + 현재순서고유번호 + ", 찾은고유번호 : " + 찾은고유번호)

          //각 branchinfo에서 선택한 버튼과 waitinfo2에서 찾은 wmac이 같은 경우만 웨이팅 사용(waitUse()호출)
          if(req.body.macNumber == "B1"){       //branchinfoB1에서 클릭한 시작버튼(wmac1)
            선택한버튼 = 1
            console.log("/branchinfoB.post >> macstatusB에서 선택한 버튼 : " + 선택한버튼)
          }
          else if(req.body.macNumber == "B2"){  //branchinfoB2에서 클릭한 시작버튼(wmac2)
            선택한버튼 = 2
            console.log("/branchinfoB.post >> macstatusB에서 선택한 버튼 : " + 선택한버튼)
          }

          console.log("/branchinfoB.post >> waitinfo에서 찾은 wmac 기기 번호 : " + 찾은기기번호)
          
          if(찾은기기번호 == 선택한버튼){
            console.log("/branchinfoB.post >> 찾은기기번호 == 선택한버튼")
            // 2) 웨이팅 사용 => 웨이팅 사용 코드
            WaitUse2()
          }
          else if(찾은기기번호 != 선택한버튼){
      ...
      function WaitUse2() {
        //db.waitinfo에서 myNumber가 찾은고유번호인 isUseWait을 true로 수정(즉, 웨이팅 사용함)
        db.collection('waitinfo2').updateOne({myNumber : 찾은고유번호}, { $set: {isUseWait:true} }, function(에러3, 결과){
          if(에러3){return console.log(에러3)}

          //db.waitinfo에서 userid가 로그인한 유저의 id인 데이터를 조회
          db.collection('waitinfo2').find({userid : req.user.id}).toArray(function(에러, 결과3) {
            var 대기번호 = 결과3[결과3.length - 1].myNumber
            var 웨이팅사용여부 = 결과3[결과3.length - 1].isUseWait
            console.log("/branchinfoB.post >> 대기번호 : " + 대기번호)
            console.log("/branchinfoB.post >> 웨이팅사용여부 is true : " + 웨이팅사용여부)

            //사용한 회원 관리
            if(웨이팅사용여부){ //웨이팅을 사용했다면..
              //db.counter에서 name이 대기인원수2인 totalWait를 -1하여 수정(즉, 총대기인원수-1)
              db.collection('counter').updateOne({name: '대기인원수2'}, { $inc: {totalWait:-1} }, function(에러1, 결과) {
                if(에러1){return console.log(에러1)}

                //db.counter에서 name이 대기인원수2인 totalUse를 +1하여 수정(즉, 총대기사용수+1)
                db.collection('counter').updateOne({name: '대기인원수2'}, { $inc: {totalUse:1} }, function(에러2, 결과) {
                  if(에러2){return console.log(에러2)}

                  console.log('/branchinfoB.post >> 웨이팅 사용(isUseWait is true) 후 사용한 회원 관리(db.counter 수정) 성공')
                  res.redirect('/')   //>>>>>>>>>>>>>>> redirect가 안먹혀서 /btncheckA1.post 시 redirect 추가
...
//2) B지점
//branchinfoB1 버튼 클릭 확인 - B지점 wmac1
app.post('/btncheckB1', function(req, res) {
  console.log("/btncheckB1.post >> branchinfoB1 버튼 클릭")
  ...
  db.collection('waitinfo2').find({userid : req.user.id}).toArray(function(에러, 결과2) {
    ...
    console.log("/btncheckB1.post >> 결과 >>")
    console.log(결과2)
    console.log("/btncheckB1.post >> 찾은사용여부 is true? : " + 찾은사용여부)

    //웨이팅 신청없이 사용하는 경우
    if(결과2.length == 0 || 찾은사용여부 == true) {
      console.log("/btncheckB1.post >> 웨이팅 신청 없이 사용하는 사람들")
      console.log("/btncheckB1.post >> 타이머3 실행")

      //타이머 시작(server) - browser의 타이머3에 시간 전달
      StartTimerB1();

      //db.branchUsage에서 branchName이 B인 isUseWmac1을 true로 변경 => 사용중임
      db.collection('branchUsage').updateOne({branchName : 'B'}, {$set : {isUseWmac1:true} }, function(에러, 결과){
        if(에러){return console.log(에러)}
        console.log('/btncheckB1.post >> db.branchUsage - B지점의 Wmac1이 true로 수정(즉, B지점 1번 세탁기 사용중)')
      })
    ...
    //웨이팅 신청하고 사용하는 경우
      ...
      console.log("/btncheckB1.post >> 찾은기기번호 == 선택한버튼")
      console.log("/btncheckB1.post >> 타이머3 실행")
...
//branchinfoB2 버튼 클릭 확인 - B지점 wmac2
app.post('/btncheckB2', function(req, res) {
  console.log("/btncheckB2.post >> branchinfoB2 버튼 클릭")
  ...
  db.collection('waitinfo2').find({userid : req.user.id}).toArray(function(에러, 결과2) {
    ...
    console.log("/btncheckB2.post >> 결과 >>")
    console.log(결과2)
    console.log("/btncheckB2.post >> 찾은사용여부 is true? : " + 찾은사용여부)

    //웨이팅 신청없이 사용하는 경우
    if(결과2.length == 0 || 찾은사용여부 == true) {
      console.log("/btncheckB2.post >> 웨이팅 신청 없이 사용하는 사람들")
      console.log("/btncheckB2.post >> 타이머4 실행")

      //타이머 시작(server) - browser의 타이머4에 시간 전달
      StartTimerB2();

      //db.branchUsage에서 branchName이 B인 isUseWmac을 true로 변경 => 사용중임
      db.collection('branchUsage').updateOne({branchName : 'B'}, {$set : {isUseWmac2:true} }, function(에러, 결과){
        if(에러){return console.log(에러)}
        console.log('/btncheckB2.post >> db.branchUsage - B지점의 Wmac2이 true로 수정(즉, B지점 2번 세탁기 사용중)')
      })
    ...
    //웨이팅 신청하고 사용하는 경우
      ...
      console.log("/btncheckB2.post >> 찾은기기번호 == 선택한버튼")
      console.log("/btncheckB2.post >> 타이머4 실행")
